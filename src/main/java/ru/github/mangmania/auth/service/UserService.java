...
import ru.github.mangmania.auth.entity.*;
import ru.github.mangmania.auth.exception.auth.EmailAlreadyExistsException;
import ru.github.mangmania.auth.exception.auth.HasActiveTokenException;
import ru.github.mangmania.auth.exception.auth.InvalidLoginException;
import ru.github.mangmania.auth.exception.auth.InvalidPasswordException;
import ru.github.mangmania.auth.exception.auth.PasswordResetTokenNotFound;
...
import ru.github.mangmania.auth.exception.auth.UsernameAlreadyExistsException;
import ru.github.mangmania.auth.exception.user.UserNotFoundException;
import ru.github.mangmania.auth.repository.*;
import ru.github.mangmania.common.error.exception.UserException;
import ru.github.mangmania.mail.service.MailService;
