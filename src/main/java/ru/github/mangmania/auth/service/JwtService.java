...
import ru.github.mangmania.auth.exception.auth.CookieEmptyException;
import ru.github.mangmania.auth.exception.auth.InvalidTokenException;
...
public class JwtService {
    ...
    public Long getUserId(HttpServletRequest httpRequest) {
        String accessToken = getAccessTokenByCookies(httpRequest.getCookies());
